namespace Lincore.Mammoth.Models
{
    ...
    /// <summary>
    /// Represents a the Mammoth Checkout Summary.
    /// </summary>
    public class MammothCheckoutSummaryModel : ICheckoutSummaryModel<MammothBillingAddressModel, StoreAddressModel, StoreLineItemModel>
    {
        /// <summary>
        ...
        /// </summary>
        public MammothBillingAddressModel BillingAddress { get; set; }

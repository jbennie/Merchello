namespace Lincore.Mammoth.PackageActions
{
    using System;
    ...
    /// <summary>
    /// This package action will Add a the Mammoth configuration section to the web.config file and establish wire up the configSource attribute to point
    ...
    public class AddConfigSection : IPackageAction
    {
        ...
        public string Alias()
        {
            return string.Concat(MammothConfiguration.ApplicationName, "_AddConfigSection");
        }
        ...
        public bool Execute(string packageName, System.Xml.XmlNode xmlData)
        {
            try
            {
                ...
                if (webConfig.Sections[MammothConfiguration.ConfigurationName] == null)
                {
                    webConfig.Sections.Add(MammothConfiguration.ConfigurationName, new MammothSection());

                    var configPath = string.Concat("App_Plugins", Path.DirectorySeparatorChar, MammothConfiguration.ApplicationName, Path.DirectorySeparatorChar, "Config", Path.DirectorySeparatorChar, MammothConfiguration.ConfigurationName, ".config");
                    ...
                    webConfig.Sections[MammothConfiguration.ConfigurationName].SectionInformation.ConfigSource = configPath;
        ...
        public bool Undo(string packageName, System.Xml.XmlNode xmlData)
        {
            try
            {
                ...
                if (webConfig.Sections[MammothConfiguration.ConfigurationName] != null)
                {
                    webConfig.Sections.Remove(MammothConfiguration.ConfigurationName);

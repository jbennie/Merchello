namespace Lincore.Mammoth.Factories
{
    ...
    /// <summary>
    /// A factory responsible for building Mammoth the <see cref="StoreSummaryModel"/>.
    /// </summary>
    public class MammothCheckoutSummaryModelFactory : CheckoutSummaryModelFactory<MammothCheckoutSummaryModel, MammothBillingAddressModel, StoreAddressModel, StoreLineItemModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MammothCheckoutSummaryModelFactory"/> class.
        /// </summary>
        public MammothCheckoutSummaryModelFactory()
        ...
        /// The <see cref="MerchelloHelper"/>.
        /// </param>
        public MammothCheckoutSummaryModelFactory(MerchelloHelper merchello)
        {

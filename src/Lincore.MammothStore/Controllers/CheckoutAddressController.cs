namespace Lincore.Mammoth.Controllers
{
    ...
    public class CheckoutAddressController : CheckoutAddressControllerBase<MammothBillingAddressModel, MammothCheckoutAddressModel>
    {
        /// <summary>
        ...
        public CheckoutAddressController()
            : base(
                  new MammothBillingAddressModelFactory(),
                  new MammothShippingAddressModelFactory())
        {
        }
        ...
        /// </returns>
        protected override ActionResult HandleBillingAddressSaveSuccess(MammothBillingAddressModel model)
        {
            string redirectUrl;
        ...
        /// The <see cref="ActionResult"/>.
        /// </returns>
        protected override ActionResult HandleShippingAddressSaveSuccess(MammothCheckoutAddressModel model)
        {

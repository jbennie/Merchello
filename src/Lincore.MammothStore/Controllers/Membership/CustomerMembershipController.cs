namespace Lincore.Mammoth.Controllers.Membership
{
    using System;
    ...
    using Lincore.Mammoth.Factories;
    using Lincore.Mammoth.Models;
    using Lincore.Mammoth.Models.Membership;
    ...
    using LoginModel = Lincore.Mammoth.Models.Membership.LoginModel;
    ...
    public class CustomerMembershipController : CustomerMembershipControllerBase
    {
        ...
        public CustomerMembershipController(NewMemberModelFactory<NewMemberModel> newMemberModelFactory)
        {
            ...
            this.BillingAddressFactory = new MammothBillingAddressModelFactory();
            this.ShippingAddressFactory = new MammothShippingAddressModelFactory();
        }

        /// <summary>
        /// Gets the <see cref="FastTrackBillingAddressModelFactory"/>.
        /// </summary>
        protected MammothBillingAddressModelFactory BillingAddressFactory { get; private set; }

        /// <summary>
        /// Gets the <see cref="FastTrackShippingAddressModelFactory"/>.
        /// </summary>
        protected MammothShippingAddressModelFactory ShippingAddressFactory { get; private set; }

namespace Lincore.Mammoth.Controllers
{
    ...
    public class CheckoutSummaryController : CheckoutSummaryControllerBase<MammothCheckoutSummaryModel, MammothBillingAddressModel, StoreAddressModel, StoreLineItemModel>
    {
        /// <summary>
        ...
        public CheckoutSummaryController()
            : base(
                  new MammothCheckoutSummaryModelFactory(),
